...
public class GcpResourceControllerTest extends BaseUnitTest {
  ...
  //   mockMvc
  //       .perform(put(operationPath).header("Authorization", String.format("bearer %s",
  // fakeToken)))
  ...
  //       mockMvc
  //           .perform(
  //               get(operationPath).header("Authorization", String.format("bearer %s",
  // fakeToken)))
  //           .andExpect(status().isOk())
  //           .andReturn()
  //           .getResponse()
  ...
  //           .getContentAsString();
  //
  //   ApiClusterStatus status = objectMapper.readValue(serializedGetResponse,
  // ApiClusterStatus.class);
  //
  ...
  // @Test
  // void clusterProxyUrl() throws Exception {
  //   String operationPath = getClusterOperationPath("proxyUrl");
  //
  //   String fakeUrl = "https://example.com";
  //   GoogleDataprocCluster cluster = mock(GoogleDataprocCluster.class);
  //   doReturn(cluster).when(gcpResourceController).getCluster(workspaceId, resourceId);
  //   when(cluster.getProxyUrl()).thenReturn(fakeUrl);
  //
  //   String serializedGetResponse =
  //       mockMvc
  //           .perform(
  ...
  //   Mockito.verify(cluster).getProxyUrl();
  // }
}
